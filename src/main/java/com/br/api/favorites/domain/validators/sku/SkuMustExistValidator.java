...
@Component
public class SkuMustExistValidator implements IFavoritesFindValidation {

    private final IFavoritesAggregationRepository aggregationRepository;

    public SkuMustExistValidator(IFavoritesAggregationRepository aggregationRepository) {
    ...
    public void validate(FavoritesFindValidationParams params) {
        ...
        if (!skuExists) {
            throw new SkuNotFoundInFavoritesException("This SKU is not in the list.");
        }
